...
extension UIView {
    ...
    */
    ...
    :returns: 约束数组
    */
    public func xmg_AlignInner(type: XC_AlignType, referView: UIView, size: CGSize?, offset: CGPoint = CGPoint.zero) -> [NSLayoutConstraint]  {
    ...
    :returns: 约束数组
    */
    public func xmg_AlignVertical(type: XC_AlignType, referView: UIView, size: CGSize?, offset: CGPoint = CGPoint.zero) -> [NSLayoutConstraint] {
    ...
    :returns: 约束数组
    */
    public func xmg_AlignHorizontal(type: XC_AlignType, referView: UIView, size: CGSize?, offset: CGPoint = CGPoint.zero) -> [NSLayoutConstraint] {
    ...
    */
    public func xmg_HorizontalTile(_ views: [UIView], insets: UIEdgeInsets) -> [NSLayoutConstraint] {
        ...
        firstView.xmg_AlignInner(type: XC_AlignType.topLeft, referView: self, size: nil, offset: CGPoint(x: insets.left, y: insets.top))
        ...
        for i in 1..<views.count {
            ...
            subView.xmg_AlignHorizontal(type: XC_AlignType.topRight, referView: preView, size: nil, offset: CGPoint(x: insets.right, y: 0))
            preView = subView
        }
    ...
    */
    public func xmg_VerticalTile(_ views: [UIView], insets: UIEdgeInsets) -> [NSLayoutConstraint] {
        ...
        for i in 1..<views.count {
            let subView = views[i]
            cons += subView.xmg_sizeConstraints(firstView)
            subView.xmg_AlignVertical(type: XC_AlignType.bottomLeft, referView: preView, size: nil, offset: CGPoint(x: 0, y: insets.bottom))
            preView = subView
        }
